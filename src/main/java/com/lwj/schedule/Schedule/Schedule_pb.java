...
//          这里的两个时间是结束时间
            ...
            j = ch2-'0';
            res = i*10+j;
            if(stuff.getEmployeepreferencesValue().charAt(9)=='3') love_arr.set((res-9)*2+8,1);
            else love_arr.set((res-9)*2+7,1);
...
//        System.out.println(working_start);
    ...
    private void fitness(ArrayList<Double> PassFlowNum,int pre,int later,ArrayList<ArrayList<Integer>> loves_arr) {
...
//        System.out.println("请稍后，正在排班中......");
        ...
        fitness(PassFlowNum, pre, later, loves_arr);
